...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->addJobButtonX->Text = L"添加任务";
			...
			this->folderAvailableSpaceLabelX->Text = L"硬盘可用大小";
			// 
			...
			this->availableSpaceTitleLabelX->Text = L"剩余空间：";
			// 
			// AddOuSnsDownloadingJob
			// 
